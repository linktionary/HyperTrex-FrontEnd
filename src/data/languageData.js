...
export const typeArr = {
        ...
        react: {
                imgUrl:
                        "https://www.bryntum.com/wp-content/uploads/2018/10/reactlogo-400x357.png",
                accentColor: "skyblue"
        },
        css: {
                imgUrl:
                        "https://files.gitter.im/scala-js/scala-js-website/iXXo/thumb/Shield-CSS.png",
                accentColor: "blue"
        },
        javascript: {
                imgUrl:
        ...
        redux: {
                imgUrl: "https://codedistrict.io/wp-content/uploads/2017/12/reduxLogo.png",
                accentColor: "#764ABC"
        },
        cpp: {
                imgUrl: "https://sdtimes.com/wp-content/uploads/2018/03/cpppp-490x490.png",
                accentColor: "#00539D"
        }
};
...
export const welcome = [
        {
                name: "Welcome to HyperTrex",
                type: "html",
                description:
                        "Welcome to HyperTrex, click the plus in the top-right hand corner to get started by adding your first card!",
                id: 6
        }
]
